        ...
        if (args[0] == "list") {
            ...
            if (!role)
              return message.channel.send(
                ...
                switch(role) {
                    case "mmorpg":
                        if (!message.member.roles.find(`name`, "🦸 MMORPG")) {
                    ...
                    break;
                    case "fps":
                        if (!message.member.roles.find(`name`, "👮 FPS")) {
                    ...
                    break;
                    case "action":
                        if (!message.member.roles.find(`name`, "👨‍🚒 Action")) {
                    ...
                    break;
                    case "adventure":
                        if (!message.member.roles.find(`name`, "👨‍🚀 Adventure")) {
                    ...
                    break;
                    case "fantasy":
                        if (!message.member.roles.find(`name`, "🧙 Fantasy")) {
                    ...
                    break;
                    case "strategy":
                        if (!message.member.roles.find(`name`, "🕵️ Strategy")) {
                    ...
                    break;
                    case "roleplay":
                        if (!message.member.roles.find(`name`, "👩‍⚕️ Roleplay")) {
                    ...
                    break;
                    case "sports":
                        if (!message.member.roles.find(`name`, "🧖 Sports")) {
                    ...
                    break;
                    case "horror":
                        if (!message.member.roles.find(`name`, "🧟 Horror")) {
                    ...
                    break;
                    case "user interface":
                        if (!message.member.roles.find(`name`, "📼 User Interface")) {
                    ...
                    break;
                    case "graphics":
                        if (!message.member.roles.find(`name`, "📺 Graphics")) {
                    ...
                    break;
                    case "programming":
                        if (!message.member.roles.find(`name`, "🖥️ Programming")) {
                    ...
                    break;
                    case "rendering":
                        if (!message.member.roles.find(`name`, "🎥 Rendering")) {
                    ...
                    break;
                    case "media":
                        if (!message.member.roles.find(`name`, "🔊 Media")) {
                    ...
                    break;
                    case "events ping":
                        if (!message.member.roles.find(`name`, "🎫 Events Ping")) {
                    ...
                    break;
                    case "news ping":
                        if (!message.member.roles.find(`name`, "📰 News Ping")) {
                    ...
                    break;
                    case "giveaway ping":
                        if (!message.member.roles.find(`name`, "🎁 Giveaway Ping")) {
